...
const rgbHelp = () => (Math.floor(randPlusMinus(155, 100)));
export const randomRGB = () => ({
  red: rgbHelp.call(this),
  green: rgbHelp.call(this),
  blue: rgbHelp.call(this),
});

export const rgbTo_s = rgb => `rgba(${Object.values(rgb).join(",")},1)`
